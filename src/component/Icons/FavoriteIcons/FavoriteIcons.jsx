...
const FavoriteIcons = ({hotels}) => {
    const [isCheck, setCheck] = useState(false);
    const dispatch = useDispatch();

    const handleClick = () => {
        setCheck((check) => !isCheck)
